...
class MyBlock(nn.Module):
    def __init__(self,input_shape ,in_channels ,out_channels, kernel_size ,kernel_num ,padding=0, stride=1):
        ...
        self.pc1 = nn.Conv2d(in_channels, out_channels, kernel_size[0],stride=stride)
        self.wl1 = nn.Conv2d(in_channels, 1, kernel_size[0],stride=stride)
...
'''
b0=MyBlock((3, 32, 32), 3, 6, (5, 5), 28*28, 0, 1)
